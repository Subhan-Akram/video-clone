...
// // const GITHUB_ASSETS_BASE_URL = "https://cdn.jsdelivr.net/gh/Th3Wall/assets-cdn/Fakeflix";//not working
// export const LANG = "en-US";
// export const REGION = "US";

// export const BASE_IMG_URL =loader;
// export const FALLBACK_IMG_URL =loader;
// export const LOGO_URL = loader;
// export const MOBILE_LOGO_URL =loader
// export const PROFILE_PIC_URL = loader
// export const SIGNIN_BGIMG_URL =loader
// export const TADUM_SOUND_URL =loader
// const ONEMONTHAGO = getOneMonthAgoReleaseDate();
// const { REACT_APP_API_KEY } = process.env;
// console.log("react api key : ",REACT_APP_API_KEY)
